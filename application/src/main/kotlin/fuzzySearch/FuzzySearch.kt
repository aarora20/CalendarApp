...
import fuzzySearch.algorithms.TokenSet
import fuzzySearch.algorithms.TokenSort
import fuzzySearch.algorithms.WeightedRatio
import fuzzySearch.ratio.PartialRatio
...
object FuzzySearch {
     ...
     * @return The simple ratio
     */
    fun ratio(s1: String, s2: String, stringFunction: fuzzySearch.ToStringFunction<String>): Int {
     ...
     * @return The partial ratio
     */
    fun partialRatio(s1: String, s2: String, stringFunction: fuzzySearch.ToStringFunction<String>): Int {
     ...
     * @return The partial ratio of the strings
     */
    fun tokenSortPartialRatio(s1: String, s2: String, stringFunction: fuzzySearch.ToStringFunction<String>): Int {
     ...
     * @return The full ratio of the strings
     */
    fun tokenSortRatio(s1: String, s2: String, stringFunction: fuzzySearch.ToStringFunction<String>): Int {
     ...
     * @return The ratio of similarity
     */
    fun tokenSetRatio(s1: String, s2: String, stringFunction: fuzzySearch.ToStringFunction<String>): Int {
     ...
     * @return The ratio of similarity
     */
    fun tokenSetPartialRatio(s1: String, s2: String, stringFunction: fuzzySearch.ToStringFunction<String>): Int {
...
//     * @return The ratio of similarity
//     */
//    fun weightedRatio(s1: String, s2: String, stringFunction: fuzzySearch.ToStringFunction<String>): Int {
//
//        return fuzzySearch.algorithms.WeightedRatio().apply(s1, s2, stringFunction)
//
//    }
//
//    /**
...
//                   func: fuzzySearch.Applicable, limit: Int, cutoff: Int): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor(cutoff)
...
//     */
//    fun extractTop(query: String, choices: Collection<String>,
//                   limit: Int, cutoff: Int): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor(cutoff)
//        return extractor.extractTop(query, choices, fuzzySearch.algorithms.WeightedRatio(), limit)
//
//    }
//
//    /**
...
//     */
//    fun extractTop(query: String, choices: Collection<String>,
//                   func: fuzzySearch.Applicable, limit: Int): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor()
//
//        return extractor.extractTop(query, choices, func, limit)
//
//    }
...
//
//    /**
//     * Creates a **sorted** list of [fuzzySearch.ExtractedResult] which contain all the choices
...
//     * @return A list of the results
//     */
//    fun extractSorted(query: String, choices: Collection<String>, func: fuzzySearch.Applicable): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor()
//
...
//     * @return A list of the results
//     */
//    fun extractSorted(query: String, choices: Collection<String>, func: fuzzySearch.Applicable,
//                      cutoff: Int): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor(cutoff)
//
//        return extractor.extractTop(query, choices, func)
...
//     * @return A list of the results
//     */
//    fun extractSorted(query: String, choices: Collection<String>): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor()
//
//        return extractor.extractTop(query, choices, fuzzySearch.algorithms.WeightedRatio())
//
//    }
//
//    /**
...
//
//    /**
//     * Creates a list of [fuzzySearch.ExtractedResult] which contain all the choices with
...
//     * @return A list of the results
//     */
//    fun extractAll(query: String, choices: Collection<String>, func: fuzzySearch.Applicable): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor()
//
...
//     * @return A list of the results
//     */
//    fun extractAll(query: String, choices: Collection<String>, func: fuzzySearch.Applicable,
//                   cutoff: Int): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor(cutoff)
//
...
//     * @return A list of the results
//     */
//    fun extractAll(query: String, choices: Collection<String>): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor()
//
//        return extractor.extractWithoutOrder(query, choices, fuzzySearch.algorithms.WeightedRatio())
//
//    }
//
//    /**
...
//     * @return A list of the results
//     */
//    fun extractAll(query: String, choices: Collection<String>, cutoff: Int): List<fuzzySearch.ExtractedResult> {
//
//        val extractor = fuzzySearch.Extractor(cutoff)
//
//        return extractor.extractWithoutOrder(query, choices, fuzzySearch.algorithms.WeightedRatio())
...
//     * @return An object containing the best match and it's score
//     */
//    fun extractOne(query: String, choices: Collection<String>): fuzzySearch.ExtractedResult {
//
//        val extractor = fuzzySearch.Extractor()
//
//        return extractor.extractOne(query, choices, fuzzySearch.algorithms.WeightedRatio())
//
//    }
//
//    /**
...
//                       toStringFunction: fuzzySearch.ToStringFunction<T>, func: fuzzySearch.Applicable,
...
//     */
//    fun <T> extractTop(query: String, choices: Collection<T>,
//                       toStringFunction: fuzzySearch.ToStringFunction<T>, limit: Int, cutoff: Int): List<BoundExtractedResult<T>> {
//
//        val extractor = fuzzySearch.Extractor(cutoff)
//        return extractor.extractTop(query, choices, toStringFunction, fuzzySearch.algorithms.WeightedRatio(), limit)
//
//    }
//
//    /**
...
//     */
//    fun <T> extractTop(query: String, choices: Collection<T>,
//                       toStringFunction: fuzzySearch.ToStringFunction<T>, limit: Int): List<BoundExtractedResult<T>> {
//
//        val extractor = fuzzySearch.Extractor()
//
//        return extractor.extractTop(query, choices, toStringFunction, fuzzySearch.algorithms.WeightedRatio(), limit)
...
//     */
//    fun <T> extractSorted(query: String, choices: Collection<T>,
//                          toStringFunction: fuzzySearch.ToStringFunction<T>): List<BoundExtractedResult<T>> {
//
//        val extractor = fuzzySearch.Extractor()
//
//        return extractor.extractTop(query, choices, toStringFunction, fuzzySearch.algorithms.WeightedRatio())
//
//    }
//
//    /**
...
//     */
//    fun <T> extractSorted(query: String, choices: Collection<T>,
//                          toStringFunction: fuzzySearch.ToStringFunction<T>, cutoff: Int): List<BoundExtractedResult<T>> {
//
//        val extractor = fuzzySearch.Extractor(cutoff)
//
//        return extractor.extractTop(query, choices, toStringFunction, fuzzySearch.algorithms.WeightedRatio())
...
//        val extractor = fuzzySearch.Extractor()
//
//        return extractor.extractWithoutOrder(query, choices, toStringFunction, fuzzySearch.algorithms.WeightedRatio())
//
//    }
//
//    /**
...
//                       toStringFunction: fuzzySearch.ToStringFunction<T>, func: fuzzySearch.Applicable): BoundExtractedResult<T> {
//
//        val extractor = fuzzySearch.Extractor()
//
...
//     */
//    fun <T> extractOne(query: String, choices: Collection<T>,
//                       toStringFunction: fuzzySearch.ToStringFunction<T>): BoundExtractedResult<T> {
//
//        val extractor = fuzzySearch.Extractor()
//
//        return extractor.extractOne(query, choices, toStringFunction, fuzzySearch.algorithms.WeightedRatio())
//
//    }
